    ...
    async def chat_completion(
        ...
        **kwargs
        ...
        if model and provider is None:
            ...
            elif "/" in model:  # OpenRouter models typically have format "provider/model"
                provider = ModelProvider.OPENROUTER
            else:
                # Default to OpenRouter for unrecognized models
                provider = ModelProvider.OPENROUTER
        elif provider is None:
            # If no model and no provider specified, default to OpenRouter
            provider = ModelProvider.OPENROUTER
